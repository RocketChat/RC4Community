...
export const Icon = dynamic(() => import('@rocket.chat/fuselage').then((comp) => comp.Icon), {
  ssr: false,
});

export const Box = dynamic(() => import('@rocket.chat/fuselage').then((comp) => comp.Box), {
  ssr: false,
});

export const Message = dynamic(() => import('@rocket.chat/fuselage').then((comp) => comp.Message), {
  ssr: false,
});
...
export const MessageToolbox = dynamic(
  () => import('@rocket.chat/fuselage').then(({ MessageToolbox }) => MessageToolbox),
  { ssr: false }
);
