    ...
    >
      <Col className='d-flex flex-column align-items-center gap-2 pt-3'>
        <h1 className={`display-6 fw-bold text-center ${styles.hero_heading}`}>
          <span className={styles.redText}>{community}</span> GSoC Contribution Leaderboard
        </h1>
          ...
          <tbody>
            {contributors.slice(0, leaderboardSize).map((contributor, index) => (
              <tr>
                ...
                >
                  <a
                    href={contributor.attributes.mergedPRsLink}
                    target={'blank'}
                  >
                ...
                >
                  <a
                    href={contributor.attributes.issuesLink}
                    target={'blank'}
                  >
