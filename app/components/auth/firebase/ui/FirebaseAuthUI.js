  ...
  if (!getInitAuthResult().success) {
    return (
      <div className='container-fluid p-1'>
        ...
        <p className='p-1'>
          Firebase authentication is used. You must set environment variables to initialize your
          firebase app. See{' '}
          <a href='https://github.com/RocketChat/RC4Community/blob/master/app/components/auth/firebase/README.md'>
            README.md
          </a>{' '}
          for setting up firebase authentication for RC4Community.
        </p>
      </div>
    );
  }
