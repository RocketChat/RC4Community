    ...
    <div>
      ...
      >
        <Col className='d-flex flex-column align-items-center gap-2 pt-3'>
          ...
          <p className={`fw-regular col-5 col-md-12 text-center ${styles.hero_subheading}`}>
            Showcase your Github Repositories
          </p>
        </Col>
        <div className={` d-flex flex-column py-1 align-items-center`}>
          <h2 className={`mx-auto w-auto mt-1 mb-5 ${styles.title}`}>Repository Overview</h2>
          <Github githubData={props.githubData} />
        </div>

        <div className={` d-flex flex-column py-1 align-items-center`}>
          <h2 className={`mx-auto w-auto mt-2  mb-5 ${styles.title}`}>GitHub Issues</h2>
          <Github
            type={'issues'}
        ...
        <div className={` d-flex flex-column py-1 align-items-center`}>
          <h2 className={`mx-auto w-auto mt-2  mb-5 ${styles.title}`}>GitHub Pull Requests</h2>
          <Github
            type={'pulls'}
            githubData={props.githubData}
          />
        ...
        <div className={` d-flex flex-column py-1 align-items-center mb-5 `}>
          <h2 className={`mx-auto w-auto mt-2  mb-5 ${styles.title}`}>Contributors ✨</h2>
          <Github
            type={'contributors'}
            githubData={props.githubData}
          />
